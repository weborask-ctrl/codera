...
| **2 · Art direction + boards** | `ECODOMCEK_ART_DIRECTION.md` citing record IDs; static boards: desktop Príjazd / Obývačka / Tech X-ray / Dollhouse / Kontakt; mobile Príjazd / a room / Kontakt; type candidates tested with the longest Slovak strings and diacritics | Boards + AD doc | Static-frame test; side-by-side with the references; Ondrej's pass |
