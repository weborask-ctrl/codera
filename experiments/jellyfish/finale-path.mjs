...
export function finalePose(progress,mobile=false,landing=false){
 ...
 return {camera:mix(pause.camera,[15,mobile?-47.5:-49,-143],t),character:mix(pause.character,[x,shelfHeight(x,z)+1.1,z],t),lookY:pause.lookY+(.01-pause.lookY)*t,pitch:.12*(1-t),yaw:-.55+.3*t,settle:ease((q-.72)/.28)};
}
